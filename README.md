...
This is a web demo built with Flask for a project about counting the number of bitstrings that can be constructed while excluding one or more bit substrings. See the [code](counting_bitstrings/bitstring_graph.py) and [overview](static/overview.pdf) for more details!
